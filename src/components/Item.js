    ...
    <>
      ...
      <div className="py-5 text-sm text-gray-600">
        ...
        <span
          ...
          className={`inline-block ml-3 align-middle cursor-pointer mr-2 text-transparent border-2 border-gray-300 rounded-full hover:border-gray-400 ${item.completed ? 'bg-blue-500 border-blue-500 text-white hover:bg-blue-400 hover:border-blue-400' : ''}`}>
